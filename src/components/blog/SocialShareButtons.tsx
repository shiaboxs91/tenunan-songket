    ...
    >
      ...
      >
        ...
        <Button
          ...
          className="flex-1 justify-start gap-2 text-green-600 hover:bg-green-50 hover:text-green-700 dark:hover:bg-green-950/30"
        ...
        <Button
          ...
          className="flex-1 justify-start gap-2 text-blue-600 hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-950/30"
        ...
        <Button
          ...
          className="flex-1 justify-start gap-2 text-stone-700 hover:bg-stone-100 dark:hover:bg-stone-800"
